        ...
        <div className='w-[85%] 2xl:w-[1240px] mx-auto gap-x-4 flex max-lg:flex-col max-lg:gap-y-4 items-center justify-between'>
          <div className='flex max-lg:flex-wrap items-center'>
            ...
            <div className='flex max-sm:hidden items-center'>
              <svg width="18" className='ml-8 cursor-pointer' height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="22" className='ml-8 cursor-pointer' height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='flex max-sm:hidden items-center ml-8'>
              ...
              <p className='text-[16px] ml-8 text-black'>Showing 1-16 of 32 results</p>
            </div>
          </div>
          <div className='flex max-sm:justify-center max-lg:flex-wrap gap-5'>
            <div className='flex items-center text-[20px] gap-3'>
              <p>Show</p>
              <input type="number" className='w-[55px] h-[55px] text-[20px] text-center text-[#9F9F9F]' defaultValue={16} />
            </div>
            <div className='flex max-sm:flex-wrap justify-center items-center text-[20px] gap-3'>
              <p>Sort by</p>
              <input type="text" className='w-[188px] h-[55px] text-[#9F9F9F] text-[20px] pl-8' defaultValue={"Default"} />
            </div>
          </div>
        </div>
      </div>
